...
abstract class Template
{
     ...
     *
     * @param string $template_file_path The path to the .html file
     ...
     *
     * @param string $key The key in the .html file (just the name e.g. 'example')
    ...
    /**
     * Gets the contents of the .html template file if it exists
     *
